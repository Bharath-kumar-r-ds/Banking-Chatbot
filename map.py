...
intent_responses = {
    ...
    'cancel_transfer': "Transfers can only be canceled if they are still in a 'Pending' state. Check the app for more details.",
    ...
    'verify_my_identity': "You can verify your identity in the app under 'Settings'.",
    'verify_source_of_funds': "You may need to provide documents to verify the source of funds. Check the app for instructions.",
    'verify_top_up': "You can verify your top-up in the app under 'Transactions'.",
    ...
    'wrong_exchange_rate_for_cash_withdrawal': "Exchange rates depend on the time of the transaction. Check the app for details."
}
